...
import 'package:i_orbit/screens/therapy_two.dart';
class TOption2 extends StatefulWidget {
  @override
  _TOption2State createState() => _TOption2State();
}

class _TOption2State extends State<TOption2> {
                    ...
                    child: Center(
                      child:SizedBox(height: 50,width: 200,
                        child: ElevatedButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>Therapy2(title:sliderDiscreteValue.round() == 0 ? "Easy" :"Hard",
                            selectedImage: sliderDiscreteValue.round() == 0 ? "assets/slideimg/tp2.gif":"assets/slideimg/tp2.gif",)));
                        },style : ButtonStyle(
