...
class Therapy3 extends StatefulWidget {
  Therapy3({Key key, this.title,this.selectedImage,}) : super(key: key);
  final String title;
  final String selectedImage;

  @override
  _Therapy3State createState() => _Therapy3State();
}

class _Therapy3State extends State<Therapy3> with TickerProviderStateMixin{
