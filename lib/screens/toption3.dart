...
import 'package:i_orbit/screens/therapy_three.dart';


class TOption3 extends StatefulWidget {
  @override
  _TOption3State createState() => _TOption3State();
}

class _TOption3State extends State<TOption3> {
                    ...
                    child: Center(
                      child:SizedBox(height: 50,width: 200,
                        child: ElevatedButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>Therapy3(title:sliderDiscreteValue.round() == 0 ? "Easy" :"Hard",
                            selectedImage: sliderDiscreteValue.round() == 0 ? "assets/slideimg/tp3.gif":"assets/slideimg/tp3.gif",)));
                        },style : ButtonStyle(
