...
import 'package:i_orbit/screens/therapy_four.dart';

class TOption4 extends StatefulWidget {

  @override
  _TOption4State createState() => _TOption4State();
}

class _TOption4State extends State<TOption4> {
                    ...
                    child: Center(
                      child:SizedBox(height: 50,width: 200,
                        child: ElevatedButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>Therapy4(title:sliderDiscreteValue.round() == 0 ? "Easy" :"Hard",
                            selectedImage: sliderDiscreteValue.round() == 0 ? "assets/slideimg/tp4.gif":"assets/slideimg/tp4.gif",)));
                        },style : ButtonStyle(
